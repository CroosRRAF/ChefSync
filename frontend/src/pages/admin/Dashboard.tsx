...
const AdminDashboard: React.FC = () => {
  ...
  const getSystemStatus = () => {
    if (pendingOrders > 50) return { status: 'High Load', color: 'bg-red-500', icon: AlertTriangle };
    if (pendingOrders > 20) return { status: 'Active', color: 'bg-yellow-500', icon: Timer };
    ...
    <div className="min-h-screen bg-gradient-to-br from-purple-50 via-white to-blue-50 overflow-x-hidden">
            ...
            <div className="flex items-center space-x-4">
              ...
              <div>
                <h1 className="text-2xl font-bold text-gray-900">
                  {getGreeting()}, Admin {user.name.split(' ')[0]}! 👑
                </h1>
                <p className="text-gray-600 flex items-center">
                  <Badge className={`${systemStatus.color} text-white mr-2`}>
                    {systemStatus.status}
                  </Badge>
                  System Administrator since {new Date(user.createdAt).getFullYear()}
                </p>
              </div>
            </div>
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pt-24 pb-24">
        ...
        <Card className="mb-8 border-none shadow-md">
          <CardHeader>
            <CardTitle className="flex items-center space-x-2">
              <systemStatus.icon className="h-5 w-5 text-purple-500" />
              <span>System Overview</span>
            </CardTitle>
            <CardDescription>Current platform operations and performance</CardDescription>
          </CardHeader>
          <CardContent>
            <div className="grid grid-cols-1 md:grid-cols-4 gap-6">
              ...
              <div className="text-center p-4 bg-blue-50 rounded-lg">
                ...
                <h3 className="font-semibold text-gray-900">Active Cooks</h3>
                <p className="text-2xl font-bold text-blue-600">{totalCooks}</p>
              </div>
              <div className="text-center p-4 bg-green-50 rounded-lg">
                ...
                <p className="text-2xl font-bold text-green-600">{totalDeliveryAgents}</p>
              </div>
              <div className="text-center p-4 bg-purple-50 rounded-lg">
                ...
                <p className="text-2xl font-bold text-purple-600">{newUsersToday}</p>
              </div>
            </div>
          </CardContent>
        </Card>
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-4 mb-8">
          <Button asChild className="h-24 flex-col space-y-2 bg-gradient-to-r from-purple-500 to-blue-500 hover:from-purple-600 hover:to-blue-600 text-white border-none shadow-md">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
          ...
          <div className="lg:col-span-2 space-y-6">
            <Card className="border-none shadow-md">
              <CardHeader>
                ...
                <CardDescription>Latest platform activities and orders</CardDescription>
              </CardHeader>
              <CardContent>
                {recentOrders.length === 0 ? (
                  <div className="text-center py-12">
                    ...
                    <p className="text-gray-500 mb-6">Platform is ready for new orders!</p>
                        ...
                        <div className="flex items-center justify-between">
                          <div className="flex items-center space-x-4 text-sm text-gray-600">
                            <span className="flex items-center space-x-1">
                              ...
                              <span>Customer ID: {order.customer_id?.slice(-4) || 'N/A'}</span>
                            </span>
          ...
          <div className="space-y-6">
              ...
              <CardContent className="space-y-4">
                ...
                <div className="space-y-3">
                  <div className="flex justify-between items-center">
                    ...
                    <span className="text-sm font-semibold">+{newUsersToday} today</span>
                  </div>
              ...
              <CardContent className="space-y-4">
                ...
                <div className="space-y-3">
                  <div className="flex items-center space-x-2 text-sm">
                    ...
                    <span className="text-gray-600">Role: Super Admin</span>
                  </div>
                  
                  <div className="flex items-center space-x-2 text-sm">
                    <Globe className="h-4 w-4 text-gray-400" />
                    <span className="text-gray-600">Platform: ChefSync</span>
                  </div>
                ...
                <div className="space-y-3">
                  ...
                  <div className="p-3 bg-yellow-50 rounded-lg border border-yellow-200">
                    <div className="flex items-center space-x-2">
                      ...
                      <span className="text-sm font-medium text-yellow-800">High Order Volume</span>
                    </div>
                    <p className="text-xs text-yellow-600 mt-1">{pendingOrders} orders pending</p>
                  </div>
                  
                  <div className="p-3 bg-blue-50 rounded-lg border border-blue-200">
                    <div className="flex items-center space-x-2">
                      <Users className="h-4 w-4 text-blue-500" />
                      <span className="text-sm font-medium text-blue-800">New Users</span>
                    </div>
                    <p className="text-xs text-blue-600 mt-1">{newUsersToday} registered today</p>
                  </div>
                </div>
              </CardContent>
            </Card>
            ...
            {/* Quick Actions */}
            <Card className="border-none shadow-md bg-gradient-to-r from-purple-400 to-blue-500 text-white">
              <CardHeader>
                <CardTitle className="flex items-center space-x-2">
              ...
              <CardContent className="space-y-3">
                <Button variant="secondary" size="sm" className="w-full bg-white text-purple-600 hover:bg-purple-50">
