    ...
    const mockNotifications: Notification[] = [
      {
        ...
        message: 'Your order #ORD-123456 has been placed and is being reviewed by the chef.',
        type: 'order',
      ...
      },
      {
        ...
        message: 'Chef has accepted your order and will start preparing your food.',
        type: 'order',
