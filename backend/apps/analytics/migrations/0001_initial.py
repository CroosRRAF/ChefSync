    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('executed_by', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='maintenance_executed', to=settings.AUTH_USER_MODEL)),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            options={
                ...
                'ordering': ['-timestamp'],
                'indexes': [models.Index(fields=['user', 'timestamp'], name='analytics_s_user_id_4ab778_idx'), models.Index(fields=['action', 'timestamp'], name='analytics_s_action_f3ed60_idx'), models.Index(fields=['resource_type', 'timestamp'], name='analytics_s_resourc_69f2c9_idx')],
            },
        ),
    ]
