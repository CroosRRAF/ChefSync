    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('image', apps.food.cloudinary_fields.CloudinaryImageField(blank=True, help_text='Food image', max_length=500, null=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('image_url', models.URLField(blank=True, help_text='Cloudinary URL for the main image', max_length=500, null=True)),
                ('thumbnail_url', models.URLField(blank=True, help_text='Cloudinary URL for thumbnail', max_length=500, null=True)),
                ('cloudinary_public_id', models.CharField(blank=True, help_text='Cloudinary public ID for management', max_length=200)),
