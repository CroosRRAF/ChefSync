...
class CommunicationEmailService:
    ...
    def send_response_notification(communication, response, responder):
        ...
        try:
            ...
            html_content = render_to_string('emails/communication_response.html', context)
    ...
    def send_communication_received_notification(communication):
        ...
        try:
            ...
            context = {
                ...
                'submitted_date': communication.created_at.strftime('%B %d, %Y at %I:%M %p'),
                'logo_base64': logo_base64,
                'site_name': 'ChefSync Kitchen',
            ...
            # Render HTML and text versions
            html_content = render_to_string('emails/new_communication_admin.html', context)
            text_content = strip_tags(html_content)
