# Generated by Django 5.2.5 on 2025-09-25 09:26
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('role', models.CharField(choices=[('admin', 'Admin'), ('Admin', 'Admin'), ('customer', 'Customer'), ('Customer', 'Customer'), ('cook', 'Cook'), ('Cook', 'Cook'), ('delivery_agent', 'Delivery Agent'), ('DeliveryAgent', 'DeliveryAgent')], default='Customer', help_text='User role in the system', max_length=20)),
                ('profile_image', apps.food.cloudinary_fields.CloudinaryImageField(blank=True, max_length=500, null=True)),
                ...
                ('status', models.CharField(choices=[('active', 'Active'), ('inactive', 'Inactive')], default='active', help_text='Activation status for all users', max_length=20)),
                ...
                ('referral_code', models.CharField(blank=True, help_text="User's unique referral code", max_length=20, null=True, unique=True)),
                ('referral_token_used', models.CharField(blank=True, help_text='Referral token that was used during registration', max_length=50, null=True)),
                ('total_referrals', models.PositiveIntegerField(default=0, help_text='Total number of successful referrals made by this user')),
                ('referral_rewards_earned', models.DecimalField(decimal_places=2, default=Decimal('0.00'), help_text='Total referral rewards earned', max_digits=10)),
                ('referral_rewards_used', models.DecimalField(decimal_places=2, default=Decimal('0.00'), help_text='Total referral rewards used', max_digits=10)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('token_type', models.CharField(choices=[('access', 'Access Token'), ('refresh', 'Refresh Token'), ('referral', 'Referral Token')], max_length=10)),
                ...
                ('referrer_reward', models.DecimalField(decimal_places=2, default=Decimal('0.00'), help_text='Reward amount for referrer', max_digits=10)),
                ('referee_reward', models.DecimalField(decimal_places=2, default=Decimal('0.00'), help_text='Reward amount for referee', max_digits=10)),
                ('campaign_name', models.CharField(blank=True, help_text='Name of the referral campaign', max_length=100, null=True)),
                ('used_by', models.ForeignKey(blank=True, help_text='User who used this referral token', null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='used_referral_tokens', to=settings.AUTH_USER_MODEL)),
