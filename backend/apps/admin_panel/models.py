...
class AdminActivityLog(models.Model):
    ...
    admin = models.ForeignKey(User, on_delete=models.CASCADE, related_name='admin_panel_activities')
...
class AdminSystemSettings(models.Model):
    ...
    updated_by = models.ForeignKey(User, on_delete=models.SET_NULL, null=True, blank=True, related_name='admin_panel_system_settings')
    updated_at = models.DateTimeField(auto_now=True)
    created_at = models.DateTimeField(auto_now_add=True)
...
class AdminBackupLog(models.Model):
    ...
    created_by = models.ForeignKey(User, on_delete=models.SET_NULL, null=True, blank=True, related_name='admin_panel_backup_logs')
    metadata = models.JSONField(default=dict, blank=True)
